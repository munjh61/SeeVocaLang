...
export const Variants = cva(
  "font-bold inline-flex items-center justify-center rounded-md",
  {
    variants: {
      bg: {
        gradientPurple: "bg-gradient-to-r from-[#8197F2] to-[#9568EF]",
        gradientGreen: "bg-gradient-to-r from-green-300 to-green-700",
        gradientOrange: "bg-gradient-to-r from-orange-400 to-orange-700",
        white: "bg-white",
        black: "bg-black",
        gray: `bg-[#F3F4F6]`,
        pp: `bg -[#F1F6FE]`,
      ...
      hover: {
        active:
          "hover:opacity-90 active:scale-95 active:shadow-inner cursor-pointer",
      },
    },
  }
);
